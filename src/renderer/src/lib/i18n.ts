...
const exact: Record<string, string> = {
  ...
  "会话已恢复到侧栏。": "Session restored to the sidebar.",
  "已归档项目": "Archived projects",
  "已归档会话": "Archived sessions",
  "暂无归档项目。": "No archived projects.",
  "暂无归档会话。": "No archived sessions.",
  "归档只会从侧栏、搜索和新建会话的项目列表中隐藏文件夹，不会删除文件夹或其中的会话。": "Archiving only hides the folder from the sidebar, search, and new-session project list. It does not delete the folder or its sessions.",
  ...
  "图片预览": "Image preview",
  "终端 pi 的 Windows 桌面端：完整继承模型、运行框架与插件系统。左侧选择项目与会话，右侧预览文件。": "A Windows desktop client for terminal Pi, with its models, harness, and extension system. Choose projects and sessions on the left and preview files on the right.",
  ...
  "原地更新）。点击下方按钮后，MPI 会自行下载并安装新版本到应用数据目录，更新完成后新开的会话使用新版本。扩展请在「插件」面板更新。": ". Use the button below to download and install a new version into app data. New sessions use it after the update. Update extensions in the Plugins panel.",
  "运行": "Run",
  "更新 pi CLI 本体（不含扩展，扩展请在「插件」面板更新）。会先检查是否为最新版本，结果以提示呈现。更新完成后新开的会话使用新版本。": "to update the Pi CLI itself. Extensions are updated separately in the Plugins panel. Pi checks the current version first, and new sessions use the updated version.",
